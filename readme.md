...
### [Chapters](https://learnyouahaskell.com/chapters)
...
4. [Syntax in Functions](http://learnyouahaskell.com/types-and-typeclasses#syntax-in-functions)
    - [Pattern matching](http://learnyouahaskell.com/types-and-typeclasses#pattern-matching)
    - [Guards, guards!](http://learnyouahaskell.com/types-and-typeclasses#guards-guards)
    - [Where!?](http://learnyouahaskell.com/types-and-typeclasses#where)
    - [Let it be](http://learnyouahaskell.com/types-and-typeclasses#let-it-be)
    - [Case expressions](http://learnyouahaskell.com/types-and-typeclasses#case-expressions)
